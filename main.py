# Code taken and adapted from https://github.com/huggingface/notebooks/blob/main/diffusers/sd_textual_inversion_training.ipynb
# Original code was licensed under Apache License 2.0
...
def do_it(args):
    ...
    if(len(args) < 1):
        raise "args doesnt provide hugging face hub token"

    hugging_token = args[0]

    os.environ["HUGGING_FACE_HUB_TOKEN"] = hugging_token
